...
;(function() {
  ...
  frame.id = 'child';
  frame.src = 'http://push.app/child.html?x=' + (new Date).getTime() + '#' + document.location.host;
  ...
  navigator.notifications.requestPermission = function requestPermission(cb) {
  ...
  navigator.notifications.checkPermission = function checkPermission(cb) {
    channel.call({method: 'checkPermission',
                  success: cb,
                  error: function(e, m){ console.log(e, m); }});
  };
})();
