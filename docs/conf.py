# -*- coding: utf-8 -*-
#
# push server documentation build configuration file, created by
# sphinx-quickstart on Mon Apr 23 13:39:00 2012.
#
...
project = u'push server'
copyright = u'2012, Jeff Balogh'
